...
export const FACEBOOK_PAGES: FacebookPageConfig[] = [
  // --- Politicians ---
  {
    ...
    name: 'Balen Shah',
    nameNe: 'बालेन शाह',
    pageUrl: 'https://www.facebook.com/balenshah',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 15,
  },
  ...
  // --- News Outlets ---
  {
    ...
    name: 'Kantipur Daily',
    nameNe: 'कान्तिपुर',
    pageUrl: 'https://www.facebook.com/kantipurdaily',
    category: 'news',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  ...
  },
  {
    ...
    nameNe: 'रिपब्लिका',
    pageUrl: 'https://www.facebook.com/myrepublica',
    category: 'news',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  {
    ...
    name: 'Online Khabar',
    nameNe: 'अनलाइन खबर',
    pageUrl: 'https://www.facebook.com/onlinekhabar',
    category: 'news',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  ...
  },
  {
    ...
    name: 'Harka Sampang',
    nameNe: 'हर्क सम्पाङ',
    pageUrl: 'https://www.facebook.com/harkasampang',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  {
    ...
    name: 'Kulman Ghising',
    nameNe: 'कुलमान घिसिङ',
    pageUrl: 'https://www.facebook.com/kulmanghising',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  {
    ...
    pageUrl: 'https://www.facebook.com/kpsharmaoli',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  {
    ...
    pageUrl: 'https://www.facebook.com/cmprachanda',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  {
    ...
    pageUrl: 'https://www.facebook.com/sherbahadurdeuba',
    category: 'politician',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
  ...
  },
  {
    ...
    pageUrl: 'https://www.facebook.com/routineofnepalbanda',
    category: 'news',
    relatedPromiseIds: [],
    maxPosts: 10,
  },
